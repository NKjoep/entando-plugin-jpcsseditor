		...
		<s:form action="save" method="post">
			<s:if test="strutsAction==1">
				<fieldset>
					...
					<p>
						<label for="jpcsseditor_filefolder" class="basic-mint-label"><s:text name="label.folder" />:</label>
						<wpsf:select list="cssFoldersMap" name="folder" id="jpcsseditor_filefolder" cssClass="text" />
					</p>
					<p>
						<label for="jpcsseditor_filename" class="basic-mint-label"><s:text name="label.file.name" />:</label>
						<wpsf:textfield name="file" id="jpcsseditor_filename" cssClass="text" />
					</p>
					<p>
